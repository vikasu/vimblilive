 ...
 */
require_once '/srv/www/htdocs/app/vendors/google_email_auto/Zend/Mime/Decode.php';

/**
 * @see Zend_Mail_Part_Interface
 */
require_once '/srv/www/htdocs/app/vendors/google_email_auto/Zend/Mail/Part/Interface.php';
    ...
    public function __construct(array $params)
    {
        if (isset($params['handler'])) {
            if (!$params['handler'] instanceof Zend_Mail_Storage_Abstract) {
                 ...
                 */
                require_once '/srv/www/htdocs/app/vendors/google_email_auto/Zend/Mail/Exception.php';
