...
require_once 'sample/src/contrib/Google_CalendarService.php';
    ...
    function get_events($myToken){
        ...
        // client id, client secret, and to register your redirect uri.
         $client->setClientId('531104926444-50t7nkpbfk823urfsvu160hil513ob7s.apps.googleusercontent.com');
         $client->setClientSecret('I2OA6WmoCEBrKA8SxZ355fdj');
         $client->setRedirectUri('http://vimbli.com/connections/googleEvent');
        ...
        if ($client->getAccessToken()) { //echo 'Hello11'; die;
          $calList = $cal->calendarList->listCalendarList();
          //print "<h1>Calendar List</h1><pre>" . print_r($calList, true) . "</pre>"; die;
        ...
        } else { //echo "Not Authorazised"; die;
          return true;
        }
    //return $events;
