...
//require_once '../../../../app/config/site_constants.php';
//echo SITE_URL; die; 
/*
...
if (isset($_GET['code'])) {
  ...
  $redirect = "http://vimbli.com/beta/connections/oauthVendor";
...
if ($client->getAccessToken()) {
  ...
  */
  ...
  $_SESSION['token'] = $client->getAccessToken();
  $tokenArr = json_decode($_SESSION['token'],true);
  $_SESSION['token_details'] = $tokenArr;
  $_SESSION['token_details']['email'] = $user['email'];
  
  //echo '<pre>'; print_r($_SESSION['token_details']); die;
} else {
...
<?php
  //print $personMarkup;
  $tokenArr = json_decode($personMarkup,true);
