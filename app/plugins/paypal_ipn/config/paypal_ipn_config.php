...
class PaypalIpnConfig {
  ...
  /************
    ...
    */
  var $settings = array(
    'business' => 'sunpro_1313731128_biz@smartdatainc.net', //'live_email@paypal.com', //Your Paypal email account
    'server' => 'https://www.paypal.com', //Main paypal server.
    'notify_url' => 'http://75.125.190.162:7280/paypal_ipn/process', //'http://www.yoursite.com/paypal_ipn/process', //Notify_url... set this to the process path of your paypal_ipn::instant_payment_notification::process action
    'currency_code' => 'USD', //Currency
    'lc' => 'US', //Locality
    'item_name' => 'Paypal_IPN', //Default item name.
    'amount' => '100.00' //Default item amount.
  );
