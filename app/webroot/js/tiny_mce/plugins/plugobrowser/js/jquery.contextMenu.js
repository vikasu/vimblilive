...
var // currently active contextMenu trigger
    ...
    handle = {
        ...
        itemClick: function(e) {
            ...
            if ($.isFunction(root.callbacks[key])) {
                ...
                if ($.isFunction(root.callback)) callback2 = root.callback;								                
    ...
    op = {
        show: function(opt, x, y) {
            ...
            $(document).off('keyup.contextMenu').on('keyup.contextMenu', handle.key);
        ...
        hide: function(opt) {
            ...
            if ($.isFunction(opt.hideCallback)) opt.hideCallback.call(opt.$trigger, $this.data('contextMenuKey'), opt);
            ...
            //$(document).off('.contextMenuAutoHide keyup.contextMenu'); // http://bugs.jquery.com/ticket/10705
            $(document).off('.contextMenuAutoHide').off('keyup.contextMenu');
            // hide menu
...
$.contextMenu = function(operation, options) {
    ...
    switch (operation) {
        ...
        case 'destroy':
            ...
            if ($.isFunction(o.hideCallback)) o.hideCallback.call(o.$trigger, '', o);
            break;
