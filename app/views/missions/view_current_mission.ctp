		       ...
		       <h3 class="hwdtwrks dshbrd timeline_small_icon">My Setup & Data</h3>
			      ...
			      <?php echo $this->Session->flash(); echo $this->Session->flash('auth');?>
				   ...
				   <?php echo $this->Form->create('Mission', array('url'=>array('controller' => 'missions','action' => 'update_mission'),'id'=>'addMissionForm', 'name'=>'addMissionForm','enctype'=>'multipart/form-data')); ?>
                                   <!--Heading-->
                                    <h3 class="wrdspcn pos_rltv">Mission<span>Detail</span>
				    <span class="edit_msn">
					<a href="<?php echo $this->Html->url(array('action'=>'current_mission_setup', base64_encode($missionDetail['Mission']['id'])));?>"><div class="blubtn-big"><input type="button" value="Edit Mission" /></div></a>
				    </span>
				    </h3>
				    ...
				    <?php /* ?>
					    ...
					    <?php foreach($missionDetail['Milestone'] as $milestone){ ?>
                                    ...
                                    <section class="milstone">
                                       ...
                                       <ul class="manag-actvty milsstnview kysccs">
                                            <li class="actvity-header odd">
                                                <section class="mng-actvty" style="width:260px !important">Description</section>
						...
						<section class="mng-time" style="width:245px !important">Keywords</section>
                                                
                                            </li>
					    <?php foreach($missionDetail['KeyToSuccess'] as $keyToSuccess){  ?>
                                            <li>
                                                <section class="mng-actvty" style="width:260px !important"><?php echo $keyToSuccess['description']; ?></section>
						...
						<section class="mng-time" style="width:80px !important"><?php echo $keyToSuccess['end_date']; ?></section>
					       <section class="mng-time" style="width:245px !important"><?php echo $keyToSuccess['ranking']; ?></section>
					...
					<!--Mission Notes- Ends-->
					    ...
					    <?php if($missionDetail['Mission']['owner'] == $_SESSION['Auth']['User']['id']){?>
						           <section class=svcnntn><a href="<?php echo $this->Html->url(array('action'=>'current_mission_setup', base64_encode($missionDetail['Mission']['id'])));?>"><div class="blubtn-big"><input type="button" value="Edit " /></div></a></section>
						   <?php } else { /*?>
