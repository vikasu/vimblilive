				...
				<div class="content">
					...
					<div class="form_default">
						<table border=0 cellpadding=0 cellspacing="0" class="tableformfield">
							...
							<tr>
                                                                <td width="120px">Meta Title <em>*</em> :</td>
                                                                <td>
							...
							<tr>
                                                                <td width="120px">Meta Description <em>*</em> :</td>
                                                                <td>
							...
							<tr>
                                                                <td width="120px">Name <em>*</em> :</td>
                                                                <td>
                                                                    <?php echo $this->Form->input('Page.name',array('size'=>'60','div'=>false,'label'=>false,'class' =>'validate[required]')); ?>
                                                                </td>
                                                        </tr>
							<tr>
                                                                <td width="120px">Title <em>*</em> :</td>
                                                                <td>
							...
							<tr>
								...
								<td>
                                                                    <?php echo $this->Form->input('Page.content',array('type' =>'textarea','cols'=>'40','rows'=>'14' ,'div'=>false,'label'=>false,'class' =>'validate[required]')); ?>
                                                                </td> 
                                                        </tr>
						</table>
						<table cellpadding="0" cellspacing="0" width="500px">
							<tr>     
							        <td>								    <?php echo $this->Form->button('Save', array('id'=>'save',"name"=>"save",'type'=>'submit','div'=>false,'label'=>false,'tabindex'=>'1','escape'=>false));?>
