...
<div class="left"> 
            <?php echo $this->Html->link('Add New Code',array('controller'=>'payments','action'=>'admin_add_code'), array('class' => 'addNewButton')); ?>
            <h1 class="pageTitle">Manage Codes</h1> 
            <?php
	    ...
	    <div class="dataTables_wrapper" id="example_wrapper">
			...
			<div id="content" class="form">                        
                                <?php echo $this->element('admin/code_listing'); ?>			
                        </div>
