...
?>
<?php
    $breadcrumbList=array( 'Reflection Questions' );
    echo $this->BreadcrumbDiv->showBreadcrumb($breadcrumbList);
?>
<?php //pr($reflections);die; ?>
<div class="left"> 
            <?php echo $this->Html->link('Add New',array('controller'=>'reflections','action'=>'admin_add_question','prefix'=>'admin'), array('class' => 'addNewButton')); ?>
            <h1 class="pageTitle">Manage Reflection Questions</h1> 
            <?php
	    ...
	    <div class="dataTables_wrapper" id="example_wrapper">
			...
			<div class="form_default">
				...
				<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
				    <tr>
					    <td>
						    <?php echo $form->create("Reflection",array("action"=>"reflections","method"=>"Post", "id"=>"frmSearchadmin", "name"=>"frmSearchadmin"));?>
			...
			<div id="content" class="form">                        
                                <?php echo $this->element('admin/reflection_listing'); ?>			
                        </div>
