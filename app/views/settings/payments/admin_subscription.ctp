...
?>
<?php
    $breadcrumbList=array( 'Manage Subscription Plans' );
...
<div class="left">
            <?php echo $this->Html->link('Add New Subscription Plan',array('controller'=>'payments','action'=>'admin_add_plan'), array('class' => 'addNewButton')); ?>

        
            <h1 class="pageTitle">Manage Subscription Plans</h1> 
            <?php
	    ...
	    <div class="dataTables_wrapper" id="example_wrapper">
			...
			<div id="content" class="form">                        
                                <?php echo $this->element('admin/plan_listing'); ?>			
                        </div>
