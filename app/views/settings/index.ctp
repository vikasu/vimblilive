...
jQuery(document).ready(function(){
	...
	if(ref_val == ''){
	    jQuery(this).attr('value','');
	    jQuery('#allActivity_weightage').attr('value','');
	    //jQuery(this).attr('value',60);
	   //jQuery('#allActivity_weightage').attr('value',40);
	   return false;
	}
    ...
    jQuery("#allActivity_weightage").keyup(function(){
	var ref_val = jQuery("#allActivity_weightage").val();
	if(ref_val > 100){
	   jQuery(this).attr('value','');
	   jQuery('#reflection_weightage').attr('value','');
	   alert('Please enter Valid No. ');
	   return false;
	}
	if(ref_val < 0){
	...
	if(ref_val == ''){
	    jQuery(this).attr('value','');
	   jQuery('#reflection_weightage').attr('value','');
	   // jQuery(this).attr('value',40);
	   //jQuery('#reflection_weightage').attr('value',60);
	   return false;
	}
	if(jQuery.isNumeric(ref_val)){
	    var act_val = 100 - ref_val;
	    jQuery('#reflection_weightage').attr('value',act_val);
	    //alert(jQuery(this).val());
	}else{
	    jQuery(this).attr('value','');
	     //jQuery(this).attr('value',40);
