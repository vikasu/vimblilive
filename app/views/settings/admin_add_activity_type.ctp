...
<div class="left">
	    ...
	    <?php echo $this->Session->flash(); ?>
		 <div class="widgetbox">
            	<h3><span>Add Activity Type</span></h3>
				<?php echo $this->Session->flash(); ?>
				<div class="content">
					...
					<?php echo $this->Form->create('Activities', array('controller' => 'activities','action' => 'add_activity_type/'.base64_encode(@$this->data['ActivityType']['id']),'prefix'=>'admin','id'=>'form')); ?>
					<div class="form_default">
						<table border=0 cellpadding=0 cellspacing="0" class="tableformfield">
							<tr>
                                                                <td width="180px">Title <em>*</em> :</td>
                                                                <td>
                                                                    <?php echo $this->Form->input('ActivityType.title',array('size'=>'50','div'=>false,'label'=>false,'class' =>'validate[required]','error'=>false)); ?>
                                                                </td>
                                                        </tr>
							<tr>
                                                                <td width="180px">Description <em>*</em> :</td>
                                                                <td>
                                                                    <?php echo $this->Form->input('ActivityType.description',array('size'=>'50','div'=>false,'label'=>false,'class' =>'validate[required]','error'=>false)); ?>
                                                                </td>
                                                        </tr>
						</table>
