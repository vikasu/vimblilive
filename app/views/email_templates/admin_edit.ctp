...
<?php echo $this->Session->flash(); ?>
    <div class="widgetbox">
    <h3><span>Edit Email Template</span></h3>
    <?php echo $this->Session->flash(); ?>
	    <div class="content">
		    <div>Note: All fields marked with (<em style="color:red;">*</em>) are required.</div>
		    <br/>
		    
		    <?php echo $this->Form->create('EmailTemplate', array('controller' => 'email_templates','action' => 'edit/'.base64_encode($this->data['EmailTemplate']['id']),'prefix'=>'admin','id'=>'form')); ?>
		    <?php echo $form->input('EmailTemplate.id', array('type' => 'hidden'));?>
		    <div class="form_default">
				...
				<span><b><?php echo $this->data['EmailTemplate']['temp_vars'] ?></b></span>
				</div>
			    </div>
			    </div>
