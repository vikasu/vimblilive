...
<div class="left"> 
            <?php echo $this->Html->link('Add New',array('controller'=>'admins','action'=>'admin_add_carousel_image','prefix'=>'admin'), array('class' => 'addNewButton')); ?>
            <h1 class="pageTitle">Manage Carousel Image</h1> 
            <?php
	    ...
	    <div class="dataTables_wrapper" id="example_wrapper">
			...
			<div id="content" class="form">                        
                                <?php echo $this->element('admin/carousel_image_listing'); ?>			
                        </div>
