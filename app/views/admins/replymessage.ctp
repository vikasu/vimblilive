...
<?php echo $this->Form->create('Admin',array('name'=>'replymsg','id'=>'replymsg','action'=>"/replymessage/$msgId"));?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
 	<td>
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        	<tr>
        		<td class="left_title"><div class="leftclass"><h2>Message/Alerts :</h2></div>
 	...
 	<td>
    	<table width="100%" border="0" cellspacing="5px" cellpadding="0">
        	<tr>
      	     ...
      	     <tr>
        		<td style="width: 185px;" align="left" valign="top"><label>User *: </label></td>
        		<td>
        		    <?php $userIdFrom = $messageDetails['Message']['user_id_from'];?>
        			<?php $messageTo = $this->requestAction("/commons/findUserById/$userIdFrom");?>
        			<?php echo $this->Form->input('Message.users',array('div'=>false,'label'=>false,'class'=>'width200','readonly'=>true,'value'=>$messageTo['User']['name']));?>
