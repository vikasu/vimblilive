        	      ...
        	      <tr> -->
        	        <td class="grid_header">
        	         <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid_brd">
        	          <tr>       	                 	            
        	            <td width="65" class="left_padd"><?php echo $this->Paginator->sort('Activity Name', 'Activity.activity_name'); ?></td>
        	        ...
        	        <?php foreach ($activitylist as $activityData) { ?>
        	        <tr>
        	        <!-- <td>
        	          <table width="100%" border="0" cellspacing="0" cellpadding="0">
        	          <tr> -->
        	            ...
        	            <td width="65" class="left_padd">
							<a href="/admins/keywordlist/<?php echo $activityData['Activity']['id'] ?>"><?php echo $activityData['Activity']['activity_name']; ?></a>
        	            </td>
           	            <td width="2" align="center">&nbsp;</td>
        	            <td width="65" align="center">
        	            	<a href="/admins/editactivity/<?php echo $activityData['Activity']['id'] ?>"><img src="/img/edit_icon.gif" alt="" width="20" title="Edit" height="17" /></a>
        	            </td>
