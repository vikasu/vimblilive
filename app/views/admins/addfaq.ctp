...
<?php echo $javascript->link('admins/addfaq.js');?>

<?php echo $this->Form->create('Admin',array('name'=>'addfaq','id'=>'addfaq'));?>
   ...
   <tr>
 	<td>
    	<table width="100%" border="0" cellspacing="5px" cellpadding="0">
      	     <tr>
        		<td align="left" valign="top" style="width:150px;"><label> Question *: </label></td>
				<td>      	     
					<?php echo $this->Form->input('Faq.faq_que',array('div'=>false,'label'=>false,'type'=>'textarea','class'=>'width200'));?>        		
      	     ...
      	     <tr>
        		<td align="left" valign="top"><label>Answer *: </label></td>
      	     ...
      	     <tr>
        		<td align="left" valign="top"><label>Sequence *: </label></td>
      	   		<td align="left" valign="top">
