 	...
 	<td>
    	<table width="100%" border="0" cellspacing="5px" cellpadding="0">
        	<tr align="left" valign="top" colspan="2">
        		<td><label>Help Topic *: </label></td>
        			<td>	
        			<?php echo $this->Form->input('Help.id');?>
        			<?php echo $this->Form->input('Help.help_topic',array('div'=>false,'label'=>false,'class'=>'width200'));?>
        		</td>
      	     </tr>
