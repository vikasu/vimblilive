...
<?php echo $this->Session->flash(); ?>
    ...
    <h3><span>Add Admin Staff</span></h3>
		...
		<td>
		    <?php echo $this->Form->input('Admin.pwd',array('type'=>'password','size'=>'60','div'=>false,'label'=>false,'class' =>'','id'=>'','value'=>'','error'=>false)); ?>
		</td>
	    </tr>
	    <tr>
		<td width="140px">Confirm Password <em>*</em> :</td>
		<td>
		    <?php echo $this->Form->input('Admin.confirmpassword',array('type'=>'password','size'=>'60','div'=>false,'label'=>false,'class' =>'','id'=>'','value'=>'','error'=>false)); ?>
		</td>
	    </tr>
	    <tr>
		...
		<td>
		    ...
		    <?php echo $this->Form->button('cancel', array('id'=>'cancel',"name"=>"cancel",'type'=>'button','div'=>false,'label'=>false,'tabindex'=>'1','escape'=>false,'onclick'=>"window.location.href = '".SITE_URL."/admin/admins/index'",'style'=>'margin-left:0px !important'));?> 
		</td>
	    </tr> 
	    </table>
        </div><!-- form_default -->
