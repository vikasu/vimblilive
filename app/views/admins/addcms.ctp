...
<?php echo $this->Form->create('Admin',array('name'=>'addcms','id'=>'addcms'));?>
    	...
    	<table width="100%" border="0" cellspacing="5px" cellpadding="0">
        	<tr>
        		...
        		<td>	
        			...
        			<?php echo $this->Form->input('Cmspage.page_title',array('div'=>false,'label'=>false,'class'=>'width200'));?></td>
      	     </tr>
			 ...
			 <tr>
        		...
        		<td>		
					<div>
						<?php echo $this->Form->select('Cmspage.link_mgr',$this->requestAction('/commons/linkMgrList'),null,array('div'=>false,'label'=>false,'empty'=>'Select','class'=>'width200'));?>
					</div>
				</td>
      	     </tr>
       	     ...
       	     <tr>
        		<td>
        			<label for="UserBioEmploymentGender">Section :</label>
				</td>
        		<td>		
					<div>
							<input type="radio" name="data[Cmspage][link_pos]" id = 'header' checked value="1"> Header
							<input type="radio" name="data[Cmspage][link_pos]" id = 'footer'  value="2"> Footer
							<input type="radio" name="data[Cmspage][link_pos]" id = 'both' value="3"> Both
					</div>
				</td>
      	     </tr>
        		...
        		<td>		
					<div>
							<input type="radio" name="data[Cmspage][cms_status]" id = 'active' checked value="1"> Active
							<input type="radio" name="data[Cmspage][cms_status]" id = 'inactive' value="0"> Inactive
					</div>
				</td>
      	     </tr>
      	      <tr>
