...
<?php echo $javascript->link('admins/edithelpcat.js');?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
 	<td>
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        	<tr>
        		<td class="left_title">Edit Help Category:
 	...
 	<td>
    	<table width="100%" border="0" cellspacing="5px" cellpadding="0">
        	<tr>
        		...
        		<td>	
        			<?php echo $this->Form->input('Helpcategory.id');?>
      	     ...
      	     <tr>
        		...
        		<td>		
					<div>
							<input type="radio" name="data[Helpcategory][hc_status]" id = 'active' value="1" <?php if(isset($this->data) && ($this->data['Helpcategory']['hc_status'] == '1')){echo "checked";}  ?> > Active
							<input type="radio" name="data[Helpcategory][hc_status]" id = 'inactive' value="0" <?php if(isset($this->data) && ($this->data['Helpcategory']['hc_status'] == '0')){echo "checked";}  ?> > Inactive
					</div>
				</td>
      	     </tr>
      	      <tr>
