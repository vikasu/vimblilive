...
?>
<?php
    $breadcrumbList=array( 'Manage Faqs' );
    echo $this->BreadcrumbDiv->showBreadcrumb($breadcrumbList);
?>

<div class="left"> 
            <?php echo $this->Html->link('Add New',array('controller'=>'faqs','action'=>'add_faq','prefix'=>'admin'), array('class' => 'addNewButton')); ?>
            <h1 class="pageTitle">Manage Faqs</h1> 
            <?php
	    ...
	    <div class="dataTables_wrapper" id="example_wrapper">
			...
			<div class="form_default">
				...
				<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
				    <tr>
					    <td>
						    <?php echo $form->create("Faq",array("action"=>"index","method"=>"Post", "id"=>"frmSearchadmin", "name"=>"frmSearchadmin"));?>
			...
			<div id="content" class="form">                        
                                <?php echo $this->element('admin/faq_listing'); ?>			
                        </div>
