         ...
         <section class="whitebox signuplogin">
             ...
             <section class=whiteboxmid>
			  ...
			  <?php echo $this->Session->flash(); echo $this->Session->flash('auth');?>
                          ...
                          <!--Transaction As-->
			  <?php echo $this->Form->create('User', array('controller' => 'users','action' => 'step2','id'=>'signUpStep2', 'name'=>'signUpStep2')); ?>
                          ...
                          <section class=regtype>
                              <div class=signuplogin-btn><?php echo $this->Form->submit('Corporate',array('name'=>'data[User][user_type]','class'=>'','div'=>false,'label'=>false)); ?></div>
                              <p>Working with a group to achieve <span>your dreams</span></p>
                          </section>
