<?php $userId = $msgData['Message']['user_id_to']?>
			...
			<tr>
		     ...
		     <tr>
      	     ...
      	     <tr>
        		<td></td>
        		<td>
					<input type="button" value="Reply" class="button" style="width:80px;" onclick="javascript:location.href='/users/replymessage/<?php echo $id;?>'"/>
	        	    
					 &nbsp;&nbsp;
	        	    <input type="button" value="Back" class="button" style="width:80px;" onclick="javascript:location.href='/users/message'"/>
