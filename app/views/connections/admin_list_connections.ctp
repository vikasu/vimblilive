	    ...
	    <div class="dataTables_wrapper" id="example_wrapper">
				    ...
				    <tbody>
						...
						<tr <?php echo $classVar?>>
							...
							<td>
							<?php
							if(!empty($page['Connection']['ConnectionEmail'] )) {
							    $contactEmail = '';
							    foreach($page['Connection']['ConnectionEmail'] as $email):
							...
							<td>
							   <?php
							    if(!empty($page['Connection']['ConnectionPhone'] )) {
                                                                $contactNum = '';
							...
							<td>
							    <?php
                                                        if(!empty($page['Connection']['ConnectionPhone'] )) {
                                                                $contactAdd = '';
                                                                foreach($page['Connection']['ConnectionAddress'] as $address):
