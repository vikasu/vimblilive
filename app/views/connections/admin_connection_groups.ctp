...
?>
<?php
    $breadcrumbList=array( 'Manage Connection Groups' );
    echo $this->BreadcrumbDiv->showBreadcrumb($breadcrumbList);
?>

<div class="left"> 
            <?php echo $this->Html->link('Add New',array('controller'=>'connections','action'=>'add_connection_group','prefix'=>'admin'), array('class' => 'addNewButton')); ?>
            <h1 class="pageTitle">Manage Connection Groups</h1> 
            <?php
	    ...
	    <div class="dataTables_wrapper" id="example_wrapper">
			...
			<div class="form_default">
				...
				<table width="100%" cellspacing="1" cellpadding="2" class="adminBox" align="center" border="0">
				    <tr>
					    <td>
						    <?php echo $form->create("Connection",array("action"=>"connection_groups","method"=>"Post", "id"=>"frmSearchadmin", "name"=>"frmSearchadmin"));?>
			...
			<div id="content" class="form">                        
                                <?php echo $this->element('admin/connection_group_listing'); ?>			
                        </div>
