                 ...
                 <section class=whiteboxmid-right>
                      ...
                      <section class=signup-pane>
                          ...
                          <ul class=form-fields>
                              <li><div class=textbox><span><input type="text" value="" placeholder="Enter your email Address" /></span></div></li>
                              <li><div class=textbox><span><input type="password" value="" placeholder="Password" /></span></div></li>
                              <li><div class="checkbox chkd"></div><div class=terms>Remember Me</div></li>
                              <li><div class=signuplogin-btn><input type="button" value="Login" /></div><a href="#" class="frgtpwd">Forgot Password?</a></li>
                          </ul>
                      </section>
                 </section>
             </section>
