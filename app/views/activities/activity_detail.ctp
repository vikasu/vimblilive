...
$('#star').raty({
  ...
  score : '<?php echo isset($activityInfo['Activity']['title']) ? $activityInfo['Activity']['rating']  : ''; ?>',
                                          ...
                                          <section class=cnnctn-detil>
                                               ...
                                               <section class=cnnctn-info>
                                                   <ul>
                                                      ...
                                                      <?php if($activityInfo['Activity']['start_date'] != "" && $activityInfo['Activity']['end_date']) { ?>
                                                      <br>
                                                      <li><?php echo 'Date: '.$activityInfo['Activity']['start_date'].' To '.$activityInfo['Activity']['end_date']; ?>
                                                      </li>
                                                      <?php } ?>
                                                      <br>
                                       ...
                                       <section class=svcnntn><i>Last Updated: <?php echo date('M. d, Y',strtotime($activityInfo['Activity']['modified'])); ?></i></section>
                                          ...
                                          <section class="notes">
                                               ...
                                               <section class="notesinfo">
                                                <?php foreach($activityInfo['ActivityAttendy'] as $participants): ?>
                                                   <p><?php echo $participants['attendy_display_name']; ?></p>
                                                <?php endforeach; ?>
                                               </section>
                                          </section>
                                          <!--Notes If Any End-->
