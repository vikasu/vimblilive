...
//require_once 'Zend/Mail/1.php';

require_once 'Zend/Mail/Protocol/Imap.php';
require_once 'Zend/Mail/Storage/Imap.php';


class GooglemailComponent extends Object
{
...
<?php     
    ...
    /*** call this function to fetch emails ******/
    function fetch_emails($email="",$accessToken=""){
	
	/*Vars needed in different functions*/
	$email="smaartdatatest@gmail.com";
	$accessToken="asdfaf_as-098908a0sf879as89";
	/************************************/
   ...
   function showInbox($imap) {
     ...
     for ($i = 1; $i <= $storage->countMessages(); $i++ ){
	//echo '<pre>'; print_r($storage->getMessage($i)); die;
        echo '<li>' . date('Y-m-d H:i:s', strtotime($storage->getMessage($i)->date)) . "</li>\n";
     }
